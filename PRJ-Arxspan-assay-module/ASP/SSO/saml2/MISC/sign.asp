...
Select Case whichServer
	...
	Case "DEV"
		session("SSORedirectURL") = "https://dev2.arxspan.com/SSO/saml2/MISC/finalize.asp"
		redirectTo = "https://dev2.arxspan.com/saml/MISC/signPDF/"
	Case "MODEL"
		session("SSORedirectURL") = "https://model.arxspan.com/SSO/saml2/MISC/finalize.asp"
		redirectTo = "https://model.arxspan.com/saml/MISC/signPDF/"
	Case "BETA"
