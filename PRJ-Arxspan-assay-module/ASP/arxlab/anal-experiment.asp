...
<%
	sectionID = "tool"
	subSectionID="anal-experiment"
	terSectionID=""

	metaD=""
	metaKey=""
%>
<!-- #include file="_inclds/experiments/anal/asp/analGetExperimentVars.asp"-->
...
<%If (canViewExperiment("4",experimentId,session("userId")) Or canRead Or hasInviteRead) And notebookVisible And experimentVisible then%>
<!-- #include file="experiments/fileUploadForm.asp"-->
<!-- #include file="_inclds/common/html/infoBox.asp"-->

<!-- #include file="_inclds/experiments/anal/js/analJSIncludes.asp"-->
<!-- #include file="_inclds/experiments/anal/js/analJS.asp"-->
<!-- #include file="_inclds/experiments/common/asp/unsavedChanges.asp"-->

<!-- #include file="_inclds/experiments/anal/html/analForm.asp"-->
