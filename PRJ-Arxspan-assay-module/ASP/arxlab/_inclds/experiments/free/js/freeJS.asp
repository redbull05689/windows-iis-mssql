...
<script type="text/javascript">
	...
	function experimentSubmit(approve,sign,autoSave,refreshPageAfterSave)
	{
		...
		*/
		...
		if(CKEDITOR.instances.e_description.hasChanges){
			experimentJSON["e_description"] = CKEDITOR.instances.e_description.getData()
		}
		...
		doServerSaveExperiment("<%=mainAppPath%>/experiments/free-saveExperiment.asp",{hiddenExperimentJSON: JSON.stringify(hiddenExperimentJSON) },sign);		
    }
