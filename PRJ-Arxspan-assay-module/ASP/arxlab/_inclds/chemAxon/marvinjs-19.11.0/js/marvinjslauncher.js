(function (win) {
	...
	function _getWrapperElement (id) {
		...
		id = (re.test(id)) ?id.substr(1) : id;
		var obj = document.getElementById(id);
		if (obj == null) {
			// If can't find by id, let's try to find by name. This addresses an issue seen on IE 11.
	...
	function _getPackage (wrapperElement) {
		if (typeof wrapperElement.contentWindow != "undefined" && typeof wrapperElement.contentWindow.marvin != "undefined") {
