...
//      if( !data.key ){
	...
	_getInnerHtml: function() {
		...
		} else if( this.hasChildren() !== false && !this.data.hideExpander) { //josh: && !this.data.hideExpander
...
//          this.isRead = false;
	...
	reloadChildren: function(callback) {
		if(this.data.hideExpander){//josh
			this.data.hideExpander = false;//josh
		}//josh
...
//              self.tree.logDebug("appendAjax().success");
		...
		serviceUrl = options.url;//joshh
		options["type"] = "POST";//josh
		options["url"] = "invp.asp";//josh
		newData = {};//joshh
		newData.url = serviceUrl;//joshh
		newData.verb = "POST";//joshh
		newData.data = JSON.stringify(options.data);//joshh
		options.data = newData;//joshh
		$.ajax(options);
	},
