function SampleWidget(parentDiv,data,fd){
	...
	console.log("SampleWidget loading Values :"+ parentDiv + ", "+ this.data +", "+ fd.fid);
...
SampleWidget.prototype.drawSquares = function(){
...
SampleWidget.prototype.makeHTML = function(){
	//required for every widget
	//must return an HTML element that contains all the initial widget HTML
	var self = this;
	return $('<div class="sampleWidgetContainer">' +
...
SampleWidget.prototype.drawHTML = function(){
	//required for every widget
...
SampleWidget.prototype.attachEventListeners = function(){
...
SampleWidget.prototype.postDraw = function(){
