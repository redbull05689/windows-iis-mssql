...
If request.Form("submit")<>"" Then
	...
	End If
	If errorString = "" Then
		strQuery = "INSERT into prepTemplatesBioSummary(name,html,companyId) values("&_
...
<h1>New Biology Summary Template</h1>
<br/>
<form action="new-prepTemplate-bio-summary.asp" method="post">
<table>
<%If errorString <> "" then%>
