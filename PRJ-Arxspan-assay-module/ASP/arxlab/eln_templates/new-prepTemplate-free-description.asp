...
If request.Form("submit")<>"" Then
	...
	End If
	If errorString = "" Then
		strQuery = "INSERT into prepTemplatesFreeDescription(name,html,companyId) values("&_
...
<h1>New Concept Description Template</h1>
<br/>
<form action="new-prepTemplate-free-description.asp" method="post">
<table>
<%If errorString <> "" then%>
