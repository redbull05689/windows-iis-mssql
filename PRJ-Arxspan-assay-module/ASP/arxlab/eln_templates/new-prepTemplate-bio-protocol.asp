...
If request.Form("submit")<>"" Then
	...
	End If
	If errorString = "" Then
		strQuery = "INSERT into prepTemplatesBioProtocol(name,html,companyId) values("&_
...
<h1>New Biology Protocol Template</h1>
<br/>
<form action="new-prepTemplate-bio-protocol.asp" method="post">
<table>
<%If errorString <> "" then%>
