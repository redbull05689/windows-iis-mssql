...
var table = $('#SummaryTable').DataTable( {
				...
				stateSaveCallback: function(settings, data) {
					...
					document.cookie="showInvitesCookie=" + JSON.stringify(data) + ";expires=" + date.toGMTString();
				},
				stateLoadCallback: function(settings) {
					return JSON.parse(getCookie("showInvitesCookie"));
				}
			} );
$.fn.dataTable.moment();
...
$.ajax({
        method: "GET",
        url: "/arxlab/table_pages/get-invites.asp",
		async: true
		}).done(function(msg) {
			var rows = msg.split(";;;");
			rows.pop();
