...
if (!Array.prototype.indexOf)
{
  ...
  function loopbackToAnchor(text, p) {
    ...
    while (anchored === false && start >= 0) {
      ...
      // Arxspan tweak for experiment comment @mentions - without this, when you choose a user, you still get the user list showing only the option you had before until you enter another character
