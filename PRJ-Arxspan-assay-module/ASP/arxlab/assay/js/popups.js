...
function blackOn(){
	...
	document.getElementById("blackDiv").style.height = document.documentElement.offsetHeight+"px";
	document.getElementById("blackFrame").style.height = document.documentElement.offsetHeight+"px";
